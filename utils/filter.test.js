...
describe("getTimeTable", () => {
  it("각 시간에 예약한 회원을 반환한다.", () => {
    ...
    expect(data).toEqual({
      1700: [{ name: "한소명", phone: "1641", date: "2022.03.23. 22:30" }],
      1900: [
        { name: "이희창", phone: "2019", date: "2022.03.23. 22:30" },
        { name: "김유곤", phone: "2863", date: "2022.03.23. 22:30" },
      ],
      2000: [{ name: "김용관", phone: "4434", date: "2022.03.23. 22:30" }],
      2100: [{ name: "김슬미", phone: "0966", date: "2022.03.23. 22:30" }],
    });
  });
  ...
  context("예약 변경 데이터일 경우", () => {
    it("예약이 변경된 상태로 저장된다.", () => {
      ...
      expect(data).toEqual({
        2000: [],
        2200: [{ name: "김용관", phone: "4434", date: "2022.03.23. 22:30" }],
      });
    });
  });
  ...
  context("예약 취소 데이터일 경우", () => {
    it("예약이 취소된 상태로 저장된다.", () => {
      ...
      expect(data).toEqual({
        1700: [],
        1900: [{ name: "김유곤", phone: "2863", date: "2022.03.23. 22:30" }],
        2000: [{ name: "김용관", phone: "4434", date: "2022.03.23. 22:30" }],
      });
    });
  });
